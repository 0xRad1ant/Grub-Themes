...
function select_theme() {
    themes=('Aesthetic' 'Anime' 'CartoonGirl' 'NeonPurple' 'SekiroShadow' 'Windows-Main' 'Cyberpunk' 'Shodan' 'fallout' 'CyberRe' 'minegrub-theme' 'Elegant-mountain' 'Wuthering-changli' 'Quit')

    PS3=$(echo_prompt '\nChoose The Theme You Want: ')
    select THEME_NAME in "${themes[@]}"; do
        case "${THEME_NAME}" in
            'Aesthetic')
                splash 'Installing Aesthetic Theme...'
                break;;
            'Anime')
                splash 'Installing Anime Theme...'
                break;;
            'CartoonGirl')
                splash 'Installing CartoonGirl Theme...'
                break;;
            'NeonPurple')
                splash 'Installing NeonPurple Theme...'
                break;;
            'SekiroShadow')
                splash 'Installing SekiroShadow Theme...'
                break;;
            'Windows-Main')
                splash 'Installing Windows-Main Theme...'
                break;;
            'Cyberpunk')
            ...
            'minegrub-theme')
                ...
                break;;
            'Elegant-mountain')
                splash 'Installing Elegant-mountain Theme...'
                break;;
            'Wuthering-changli')
                splash 'Installing Wuthering-changli Theme...'
                break;;
            'Quit')
...
function main() {
    ...
    echo_success 'Grub theme updated successfully!'
